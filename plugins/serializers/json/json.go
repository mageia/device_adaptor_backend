...
func (s *serializer) Serialize(metric device_adaptor.Metric) ([]byte, error) {
...
func (s *serializer) SerializeBatch(metrics []device_adaptor.Metric) ([]byte, error) {
...
func (s *serializer) SerializeMap(metric device_adaptor.Metric) (map[string]interface{}, error) {
	m := s.createObject(metric)
	return m, nil
}

func (s *serializer) SerializePoints(pointMap device_adaptor.PointMap) (map[string]interface{}, error) {
...
func (s *serializer) createObject(metric device_adaptor.Metric) map[string]interface{} {
